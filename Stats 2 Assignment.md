...
Since the populaulation std dev is not given and the sample size is less than 30, we use t-test
...
−𝑡0.05 leaves an area of 0.05 to the left and 𝑡0.10 leaves an area of 0.10 to the right. 
